...
def timegan (ori_data, parameters, num_of_data_to_be_generated):
  """TimeGAN function.
  ...
  count = int(num_of_data_to_be_generated / no)
  ...
  # Renormalization
    ...
    if len(all_generated_data) == 0:
        all_generated_data = generated_data
    else:
